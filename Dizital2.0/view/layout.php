            ...
            <div class="mixitup-gallery">
                ...
                <div class="row">
				  <div class="span8">
				    <div class="row">
				      <div class="span8">
				        <h3 class="undefined"><strong><a class="h3_class" href="blog-single.php?post_id="></strong>
				        </h3>
				      </div>
				    </div>
				    <div class="row">
				      <div class="span2">
				            <img class="img_news" width="520" height="520" src="" alt="">
				      </div>
				      <div class="span6">      
				        <p class="p_align"><a class="read_more" href="blog-single.php?post_id=">Read more</a></p>
				      </div>
				    </div>
				    <div class="row">
				      <div class="span8">
