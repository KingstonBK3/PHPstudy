            ...
            <div class="mixitup-gallery">
                ...
                <div class="row">
				  <div class="span8">
				    <div class="row">
				      <div class="span8">
				        <h3 class="undefined"><strong><a class="h3_class" href="blog-single.php?post_id=<?=$value['id']?>"><?=$value['title']?></a></strong></h3>
				      </div>
				    </div>
				    <div class="row">
				      <div class="span2">
				            <img class="img_news" width="520" height="520" src="<?=$value['img']?>">
				      </div>
				      <div class="span6">      
				        <p class="p_align"><a class="read_more" href="blog-single.php?post_id=<?=$value['id']?>">Read more</a></p>
				      </div>
				    </div>
				    <div class="row">
				      <div class="span8">
				        <p></p>
				        <p>
				          <i class="author-image"><img width="27" height="27" src="images/resource/author-2.jpg" alt=""></i>
				          <i class="icon-user"></i><?=$value['user']?>
				          <div><?=$value['category']?></div> 
				          <i class="post-date"><?=$value['date']?></i>-->
				        </p>
				        <hr>
				      </div>
				    </div>
